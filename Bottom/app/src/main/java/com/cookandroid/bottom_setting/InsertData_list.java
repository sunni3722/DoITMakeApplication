...
class InsertData_list extends AsyncTask<String, Void, String> {
    ...
    public InsertData_list(String IP, ContentValues contentValues, Context context) {
        this.url1 = "http://" + IP + "/naver_list_insert.php";;
